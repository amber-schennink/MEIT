...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  <body>
    ...
    <div class="container">
      <h4 class="w-fit m-auto mb-5"><a href="{{url('login')}}" class="hover:underline underline-offset-2 text-second">Log in</a> om jouw plek te reserveren voor een ceremonie of het MEIT. Traject</h4>
