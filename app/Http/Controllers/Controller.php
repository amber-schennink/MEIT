    ...
    if($request->deelnemer_type){
      if($request->deelnemer_type == 'form'){
        $request->validate([
          ...
          'deelnemer_telefoon'                  => 'required|string',
          'geboorte_datum'                      => 'required|date',
          'geboorte_tijd'                       => 'required|string',
          'geboorte_plaats'                     => 'required|string',
        ], [
          ...
          'deelnemer_telefoon.required'   => 'Vul je telefoonnummer in.',
          'geboorte_datum.required'       => 'Vul je geboortedatum in.',
          'geboorte_tijd.required'        => 'Vul je geboortetijd in.',
          'geboorte_plaats.required'      => 'Vul je geboorteplaats in.',
        ], [
